    ...
    <motion.main
      ...
      <ol className="relative border-l border-gray-200 dark:border-gray-700">
        <li className="mb-10 ml-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">National Institute of Technology, Bhopal</h3>
        ...
        <li className="mb-10 ml-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Katonic.ai</h3>
          <p className="text-base font-normal text-gray-500 dark:text-gray-400">Started working as Full-Stack Engineer Intern</p>
        </li>
        <li className="mb-10 ml-4">
          <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
